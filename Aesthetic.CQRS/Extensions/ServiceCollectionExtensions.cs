...
public static class ServiceCollectionExtensions
{
    ...
    private static IServiceCollection ApplyExerciseCommands(this IServiceCollection services)
        => services
            ...
            .AddScoped<IHandler<ICommand<ExerciseDto>, ExerciseDto, string>,
                PrepareFileUploadingForEntityCommandHandler<ICommand<ExerciseDto>, ExerciseDto, Exercise, ExerciseFileUploaded>>();
